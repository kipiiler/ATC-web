...
//   return (
//     <div className="relative flex items-center w-full justify-center py-16 md:py-24 bg-[#735D78]">
...
const NewsSection = () => {
  ...
  return (
    <div className="relative flex items-center w-full justify-center py-24 bg-gradient-to-br from-[#2F1947] to-[#735D78] text-white overflow-hidden">
